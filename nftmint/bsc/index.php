...
//header('Location: https://cash.dirty.finance/nft');
    // exit();
			        ...
			        <div class="col-md-12">
			          ...
			          <div id="prepare">
			            <button class="btn btn-success pull-right" id="btn-connect">
			              Connect wallet&nbsp;&nbsp;
                    <img class="pull-right" src="bsc.svg" width="24px" heigh="24px">
			            </button>
				...
				<div id="connected" style="display: none">
				            ...
				            <div id="correctnetwork">
				            	<div class="row">
				            		<div class="col-md-8">
						              <p>
						                <strong>Connected blockchain:</strong> <span id="network-name"></span><span><img src="bsc.svg" width="48px" heigh="48px"></span>
						              </p>
						              ...
						              <p>
						                <strong>BNB Balance:</strong> <span id="my-eth-balance" style="color:blue"></span>
						              </p>
				              	...
				              	<div class="col-md-4">
				              		<button id="mint-nft" class="btn btn-success" style="background-color:mediumvioletred;border-color:mediumvioletred; display:none" onclick="mintNFT()">Mint promotional NFT</button>
				              		<br>
				              		<div id="nft-tx" style="display: none; word-break: break-all;"></div>
				              		<div id="showLoading" style="display: none"><img src="loading.svg"></div>
				              		<div id="submitted" class="alert alert-info" style="display:none">Transaction Submitted!</div>
				              		<div id="approved" class="alert alert-success" style="display:none">Transaction Successful!</div>
                          <div id="validation" style="display: none; word-break: break-word;"></div><br><br>
                          <button id="get-bnb" class="btn btn-warning" style="display:none" onclick="getBNB()">Send me BNB gas!</button>
                        ...
                        <div class="col-md-6">
                          <div class="content-area additional" style="margin-right:3%">
				            ...
				            <div id="incorrectnetwork">
				              <p>
				                <strong>You are connected to the wrong blockchain!</strong></span>
				              </p>

				              <p>
				                <strong>Please connect your wallet to the Binance Smart Chain Mainnet</strong></span>
				              </p>
...
<button onclick="topFunction()" id="myBtn" title="Go to top"><i class="fa fa-angle-double-up"></i></button>
    ...
    <script type="text/javascript" src="dirty_snapshot.js"></script>
...
if( isset($_SESSION["account"])) {
 ...
 <script>
  ...
  $(document).ready(function() {
     ...
     var myVariable = <?php echo(json_encode($_SESSION["account"])); ?>;
  //onConnect(myVariable);
  }) 
