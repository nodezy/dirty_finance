...
contract KojiToken is Context, IERC20, Ownable {
    ...
    string private constant NAME = "DIRTY";
    string private constant SYMBOL = "dirty.finance";
    ...
    uint256 public taxPercentage = 5;     //5% Total
    uint256 public holderTaxAlloc = 20;   //2%
    uint256 public regenTaxAlloc = 10;  //1%
    uint256 public burnTaxAlloc = 20;      //2%
